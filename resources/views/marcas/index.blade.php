...
@section("content")
  ...
  <div class="form-group row">
      <div class="col-sm-4">
        <button class="btn btn-primary" data-toggle="modal" data-target="#create">Agregar marcas</button>
      </div>
      <div class="col-sm-8">
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="form-group row">
            {!! Form::open(["route"=>"Marcas.store","method"=>"POST","id"=>"form"]) !!}
              @csrf
  ...
  <div class="modal fade" id="modal_edit" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="form-group row">
            {!! Form::open(["route"=>["Marcas.update",0],"method"=>"POST","id"=>"update"]) !!}
              @csrf
              @method('PUT')
              <div class="modal_edit">
                  ...
                  {!! Form::label('marca', 'Marca', ['class' => 'col-sm-2 col-form-label']) !!}
                  <div class="col-sm-10">
                    {!! Form::text('edit_marca',null,['class'=>'form-control']) !!}
                  </div>
              </div>
          </div>
        </div>
  ...
  <div class="modal fade" id="modal_delete" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="form-group row">
            {!! Form::open(["route"=>["delete_mark",0],"method"=>"GET","id"=>"delete"]) !!}
                <center>
