...
@section("content")
  ...
  <div class="form-group row">
      <div class="col-sm-4">
        <button class="btn btn-primary" data-toggle="modal" data-target="#create">Agregar submarcas</button>
      </div>
      <div class="col-sm-8">
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Registrar Submarca</h4>
        </div>
        <div class="modal-body">
          <div class="form-group row">
            {!! Form::open(["route"=>"Submarcas.store","method"=>"POST","id"=>"form"]) !!}
              @csrf
              {!! Form::label('submarca', 'Submarca', ['class' => 'col-sm-2 col-form-label']) !!}
              <div class="col-sm-10">
                {!! Form::text('submarca',null,['class'=>'form-control']) !!}
              </div>
          </div>
        </div>
  ...
  <div class="modal fade" id="modal_edit" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Modificar Submarca</h4>
        </div>
        <div class="modal-body">
          <div class="form-group row">
            {!! Form::open(["route"=>["Submarcas.update",0],"method"=>"POST","id"=>"update"]) !!}
              @csrf
              @method('PUT')
              <div class="modal_edit">
                  ...
                  {!! Form::label('submarca', 'Submarca', ['class' => 'col-sm-2 col-form-label']) !!}
                  <div class="col-sm-10">
                    {!! Form::text('edit_submarca',null,['class'=>'form-control']) !!}
                  </div>
              </div>
          </div>
        </div>
  ...
  <div class="modal fade" id="modal_delete" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="form-group row">
            {!! Form::open(["route"=>["delete_sub",0],"method"=>"GET","id"=>"delete"]) !!}
                <center>
